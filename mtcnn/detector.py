...
def get_net():
    ...
    return {
        ...
        'device': device,
        'run_first_stage': run_first_stage,
        'convert_to_square': convert_to_square,
        'get_image_boxes': get_image_boxes
    }


def detect_faces(image, net, min_face_size=20.0,
    ...
    with torch.no_grad():
        ...
        for s in scales:
            boxes = run_first_stage(
                image, net['pnet'], scale=s, threshold=thresholds[0])
